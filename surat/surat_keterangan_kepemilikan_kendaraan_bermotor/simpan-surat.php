<?php
    ...
    if (isset($_POST['submit'])){
        ...
        $qTambahSurat = "INSERT INTO surat_keterangan_kepemilikan_kendaraan_bermotor (jenis_surat, nik, merk_type, jenis_model, tahun_pembuatan, cc, warna_cat, no_rangka, no_mesin, no_polisi, no_bpkb, atas_nama_pemilik, alamat_pemilik, keperluan, status_surat) VALUES('$jenis_surat', '$nik', '$merk_type', '$jenis_model', '$tahun_pembuatan', '$cc', '$warna_cat', '$no_rangka', '$no_mesin', '$no_polisi', '$no_bpkb', '$atas_nama_pemilik', '$alamat_pemilik', '$keperluan', '$status_surat')";
